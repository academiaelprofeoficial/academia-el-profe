        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="max-w-md mx-auto px-4 py-20 text-center">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link href={backUrl} className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl border border-border/40 text-sm font-medium text-foreground hover:bg-muted/30 transition-colors">
