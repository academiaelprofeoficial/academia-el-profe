...
export interface SanityClassVideo { title?: string; description?: string; video?: SanityVideoAsset; videoUrl?: string; sharedVideo?: SanitySharedVideo; duration?: string; topic?: string; isFree?: boolean; order?: number; }
export interface SanityTopicMaterial { title?: string; topic?: string; file?: SanityVideoAsset; order?: number; isFree?: boolean; }
export interface SanityCourse { _id: string; title: string; slug: string; coverImage?: SanityImage | null; category?: string; description?: PortableTextBlock[]; professor?: string; topics?: Array<{ title: string; description?: string; classes?: number }>; pricePEN?: number; priceUSD?: number; totalClasses?: number; totalHours?: string; level?: string; featured?: boolean; order?: number; courseType?: 'free' | 'paid'; courseVideo?: SanityVideoAsset; videoUrl?: string; classVideos?: SanityClassVideo[]; topicMaterials?: SanityTopicMaterial[]; }
