...
export interface SanityProfesor { _key?: string; nombre?: string; titulo?: string; descripcion?: string; foto?: SanityImage | null; }
export interface SanityCaracteristica { _key?: string; icono?: string; titulo?: string; descripcion?: string; }
